...
var o23397 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23397["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23398 = temp__5455__auto____$1;
return (o23398["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22478__auto__ = f;
return (o__22478__auto__["toString"]).call(o__22478__auto__);
} else {
return "";
}
}catch (e23399){var _ = e23399;
return "";
}});
...
try{var o__22478__auto___23401 = t;
(o__22478__auto___23401["cljs$lang$ctorPrWriter"]).call(o__22478__auto___23401,t,writer);
}catch (e23400){var __23402 = e23400;
}
...
var char_code = (function (){var o__22478__auto__ = (new String(char$));
return (o__22478__auto__["charCodeAt"]).call(o__22478__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22478__auto__ = String;
return (o__22478__auto__["fromCharCode"]).call(o__22478__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23403 = num_code;
switch (G__23403) {
case (1):
return (185);
...
var o__22478__auto__ = String;
return (o__22478__auto__["fromCharCode"]).call(o__22478__auto__,superscript_code);
});
/**
...
}catch (e23405){var _e__22485__auto__ = e23405;
return false;
}})())){
...
var vec__23406 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23406,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23409 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23409["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23410 = temp__5455__auto____$1;
return (o23410["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___23417 = arguments.length;
var i__4500__auto___23418 = (0);
while(true){
if((i__4500__auto___23418 < len__4499__auto___23417)){
args__4502__auto__.push((arguments[i__4500__auto___23418]));

var G__23419 = (i__4500__auto___23418 + (1));
i__4500__auto___23418 = G__23419;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23413){
var vec__23414 = p__23413;
var ns_detector = cljs.core.nth.call(null,vec__23414,(0),null);
...
var G__23420 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23421 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23420;
remaining_tokens = G__23421;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23411){
var G__23412 = cljs.core.first.call(null,seq23411);
var seq23411__$1 = cljs.core.next.call(null,seq23411);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23412,seq23411__$1);
});
...
var vec__23425 = cljs.core.split_with.call(null,(function (p1__23424_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23424_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23425,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23425,(1),null);
...
var vec__23428 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23428,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23428,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23431 = cljs.core.rest.call(null,remaining_tokens);
var G__23432 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23431;
name_tokens = G__23432;
continue;
} else {
...
var vec__23435 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23435,(0),null);
var arity = cljs.core.nth.call(null,vec__23435,(1),null);
var vec__23438 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23438,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23438,(1),null);
var vec__23441 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23441,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23441,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23441,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23441,(3),null);
...
var vec__23447 = result;
var munged_ns = cljs.core.nth.call(null,vec__23447,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23447,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23447,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23447,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23447,(4),null);
var arity = cljs.core.nth.call(null,vec__23447,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23451 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23451,(0),null);
var args = cljs.core.nth.call(null,vec__23451,(1),null);
var vec__23454 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23454,(0),null);
var name = cljs.core.nth.call(null,vec__23454,(1),null);
...
var G__23457 = (arity + (1));
var G__23458 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23459){
var vec__23460 = p__23459;
var arity = cljs.core.nth.call(null,vec__23460,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23460,(1),null);
...
return cljs.core.get.call(null,arities,p1__23463_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23464_SHARP_);
...
var args__4502__auto__ = [];
var len__4499__auto___23471 = arguments.length;
var i__4500__auto___23472 = (0);
while(true){
if((i__4500__auto___23472 < len__4499__auto___23471)){
args__4502__auto__.push((arguments[i__4500__auto___23472]));

var G__23473 = (i__4500__auto___23472 + (1));
i__4500__auto___23472 = G__23473;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23467){
var vec__23468 = p__23467;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23468,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23465){
var G__23466 = cljs.core.first.call(null,seq23465);
var seq23465__$1 = cljs.core.next.call(null,seq23465);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23466,seq23465__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23476__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23476__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23476__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23476__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23477 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23477,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23477,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23477,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23477,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23477,(4),null);
var arity = cljs.core.nth.call(null,vec__23477,(5),null);
...
var o__22478__auto__ = f;
return (o__22478__auto__["getBasis"]).call(o__22478__auto__);
});
/**
...
}catch (e23481){var _e__22485__auto__ = e23481;
...
var G__23482 = (obj[cljs.core.first.call(null,path)]);
var G__23483 = cljs.core.rest.call(null,path);
obj = G__23482;
path = G__23483;
continue;
} else {
...
return (function (accum,p__23484){
var vec__23485 = p__23484;
var bit = cljs.core.nth.call(null,vec__23485,(0),null);
var protocol = cljs.core.nth.call(null,vec__23485,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23488){
var vec__23489 = p__23488;
var ns = cljs.core.nth.call(null,vec__23489,(0),null);
var name = cljs.core.nth.call(null,vec__23489,(1),null);
var selector = cljs.core.nth.call(null,vec__23489,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23494,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23494,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23494,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23492_SHARP_){
return (obj[cljs.core.first.call(null,p1__23492_SHARP_)]);
});})(name,sorted_matches,vec__23494,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1544241697879
