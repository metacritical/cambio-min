...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23525){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23526,G__23527,seq23525__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23531_SHARP_){
return !((cljs.core.meta.call(null,p1__23531_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__23532__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23536){var _e__22485__auto__ = e23536;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e23538){var _e__22485__auto__ = e23538;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23540 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23541 = opts;
var map__23541__$1 = ((((!((map__23541 == null)))?(((((map__23541.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23541.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23541):map__23541);
var markup_db = cljs.core.get.call(null,map__23541__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23540;
}});
...
;
var temp__5455__auto___23545 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23545)){
var managed_print_level_23546 = temp__5455__auto___23545;
var _STAR_print_level_STAR_23544_23547 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23546;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23544_23547,managed_print_level_23546,temp__5455__auto___23545,writer,opts,job_fn){
return (function (p1__23543_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23543_SHARP_,null);
});})(_STAR_print_level_STAR_23544_23547,managed_print_level_23546,temp__5455__auto___23545,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23544_23547;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1544373039029
