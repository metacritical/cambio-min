...
cambio_360.core.resize.call(null);
...
cambio_360.core.resize = (function cambio_360$core$resize(){
cambio_360.core.renderer.setSize(window.innerWidth,window.innerHeight);

return cambio_360.core.camera.aspect = (window.innerWidth / window.innerHeight);
});
cambio_360.core.setsize = (function cambio_360$core$setsize(){
return window.addEventListener("resize",cambio_360.core.onResize,false);
});
...
cambio_360.core.setsize.call(null);
...
//# sourceMappingURL=core.js.map?rel=1544376520031
